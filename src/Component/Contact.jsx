        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          >
            <div className="text-center">
              <div
                className={`w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full transform transition-transform duration-300 hover:rotate-12 ${
            ...
            {success && (
              <div className="mt-4 animate-slide-in overflow-hidden">
                ...
                >
                  ...
                  <span
                    className={isDarkMode ? "text-green-200" : "text-green-700"}
                  >
            ...
            {error && (
              <div className="mt-4 animate-slide-in overflow-hidden">
                ...
                >
                  ...
                  <span
                    className={isDarkMode ? "text-red-200" : "text-red-700"}
                  >
