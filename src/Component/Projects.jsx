  ...
  const projects = [
    {
      ...
      description: [
        ...
        "These containers were then deployed and orchestrated within AWS EKS, ensuring high availability and scalability. The architecture comprises a frontend, backend, and database layer, each deployed as separate services, allowing seamless communication and efficient management of the application on the cloud."
      ],
      tools: ["Docker", "AWS EKS", "Kubernetes", "AWS EC2", "Git", "Maven","VSCode","AWS RDS","Spring boot"],
      liveDemo: "https://example.com/live-demo/aws-cloud-adoption",
      github: "https://github.com/yourusername/aws-cloud-adoption",
    ...
    },
    {
      ...
      tools: ["React", "Spring Boot", "MySQL", "Bootstrap", "VSCode", "Git", "JWT", "Maven"],
      liveDemo: "https://example.com/live-demo/redhat-automation",
      github: "https://github.com/yourusername/redhat-automation",
    ...
    },    
    {
      ...
      tools: ["Jenkins", "SonarQube", "Nexus OSS", "Docker", "AWS EKS", "Git Bash", "Maven","AWS EC2"],
          ...
          <div className="w-full sm:w-5/6 md:w-4/5 lg:w-2/3 xl:w-3/5 overflow-hidden">
            ...
            >
              {projects.map((project, index) => (
                <div
                  key={index}
                  className={`flex-shrink-0 w-full rounded-lg shadow-lg p-10 ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
                >
                  <div className="flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div className="w-full lg:w-3/5 lg:pl-6">
                      <h3 className={`text-3xl font-semibold mb-4 ${isDarkMode ? "text-white" : "text-black"}`}>
                        {project.title}
                      </h3>
                      <div className={`mt-4 text-base ${isDarkMode ? "text-gray-300" : "text-gray-700"} text-justify`}>
                        <ul>
